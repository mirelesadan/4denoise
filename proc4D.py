...
def reconstruct_height(xGrad, yGrad, y_bds_flat, x_bds_flat, iterations=10, threshold_percent=5, 
    ...
    """
    xCorr = fix_sign_errors(xGrad, window_shape=box_size)
    yCorr = fix_sign_errors(yGrad, window_shape=box_size)
    ...
    for i in range(iterations):
        ...
        if i < iterations - 1:
            ...
            xCorr = fix_sign_errors(xCorr, window_shape=box_size)
            yCorr = fix_sign_errors(yCorr, window_shape=box_size)
...
class HyperData:
    ...
    def standardize(self):
        ...
        standardized_tensor : ndarray
            The standardized dataset with zero mean and unit variance.
        """
